...
function userVerify($username,$pass,$validated){
  global $db0;
  $ip = userIP();
  $sel = 'select name,email,display,signname,detail,password, country, spoken, signed, interface, dictionary, literature, fingerspell, alphabet, keyboard from user where name=:username;';
  try {
