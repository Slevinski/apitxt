python txt2compile.py -d index -s "root user collection interface tools fsw swu apitxt" -j -l
...
python txt2compile.py -d index -s "main  user user-files collection collection-files interface interface-files tools tools-files fsw fsw-files swu swu-files apitxt apitxt-files" -p
python txt2compile.py -d index -s "user collection interface tools fsw swu apitxt" -m
