...
print "var host = \"\";"
print "try {"
print "  host = config['state']['connection']['server'];"
print "} catch (e){"
print " host = \"" + root['host'] + "\""
print "}"
...
print "            var headers = (((method[\"dialog\"] || [])[0] || {})[\"request\"] || {})[\"headers\"] || [];"
print "            return ["
print "              m(\"form\","
print "                m(\"fieldset\",["
...
print "                  Object.keys(headers).map(function(key){"
print "                    if (key == \"Location\" || key == \"Description\" || key == \"Content-type\") return;"
print "                    return m(\"p\",["
print "                      m(\"label[for=\" + id + key + \"]\", \"HEADER \" + key),"
print "                      m(\"input#\" + id + key + \"[type=text][name=\"+ key + \"]\",{"
print "                        \"value\":headers[key],"
print "                        onchange: function(e){data[\"groups\"][iG][\"routes\"][iR][\"methods\"][iM][\"dialog\"][0][\"request\"][\"headers\"][key]=e.target.value;}"
print "                      })"
print "                    ]);"
print "                  }),"
print "                  (route[\"parameters\"] || []).map(function(param,iP){"
print "                    param[\"example\"] = param[\"example\"].replace(/`/g, \"\");"
print "                    return m(\"p\",["
