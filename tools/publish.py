# publish.py is a python script to copy files to the client directory
#
...
# Argument Setup
##################
parser = argparse.ArgumentParser(description="API Blueprint to HTML documentation conversion and other files to client directory"
...
os.system('cp ' + args.output + args.document + '.html ../client/api/.')
os.system('cp ' + args.output + args.document + '.js ../client/api/.')
os.system('cp ' + args.output + args.document + '.txt ../client/src/.')
os.system('cp ' + args.output + args.document + '.json ../client/src/.')
os.system('cp ' + args.output + args.document + '.md ../client/doc/.')
os.system('cp ' + args.output + args.document + '.htm ../client/doc/.')
